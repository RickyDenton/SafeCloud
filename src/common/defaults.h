...
#define SRV_USER_PUBK_PATH(username) SRV_USER_HOME_PATH(username) username "_pubk.pem"
...
#define CLI_USER_PRIVK_PATH(username) CLI_USER_HOME_PATH(username) username "_privk.pem"
